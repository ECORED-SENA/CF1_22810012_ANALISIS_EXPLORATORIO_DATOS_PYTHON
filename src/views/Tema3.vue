              ...
              .row.align-items-center.mb-4
                .col-lg-8.mb-4.mb-lg-0
                  .cajon.color-secundario.p-4
                    ...
                    p ¿La calidad de atención a la clientela, es lo que se considera de mayor valor intangible en su negocio?
                .col-lg-4
                  figure
            ...
            .col-12
              ...
              .row.align-items-center
                .col-lg-8.mb-4.mb-lg-0
                  .cajon.color-secundario.p-4
                    p.mb-0 #[b Ejercicio reflexivo]
                    p Es un valor agregado que, en la tienda de café, los clientes puedan moler y llevar a preparación la bebida que van a consumir.
                .col-lg-4
                  figure
            ...
            .col-12
              ...
              .row.align-items-center
                .col-lg-8.mb-4.mb-lg-0
                  .cajon.color-secundario.p-4
                    p.mb-0 #[b Ejercicio reflexivo]
                    p Los clientes del negocio, ¿disfrutan la preparación de producto, tanto para ellos mismos como para otros clientes?
                .col-lg-4
                  figure
