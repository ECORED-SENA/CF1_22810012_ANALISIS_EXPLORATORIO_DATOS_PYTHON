  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        ...
        p.mb-4 #[b Objetivo]. Recordar lo aprendido sobre los pasos a seguir en la preparación del análisis exploratorio de los datos.
    ...
    .row.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        ...
        p.mb-4 #[b Objetivo]. Apropiarse de los conceptos necesarios para el análisis exploratorio de datos.
        .tarjeta.actividad.p-3
          .row.justify-content-around.align-items-center            
            .col-sm.mb-3.mb-sm-0
